...
class TestGradeItem(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.me = cls.course.get_member(141809880) # gets Ahmad Khalil's OrgMember object
        pass
    ...
    def test_create_grade(self):
        self.grade_item_1.create_grade(self.me, "This is a test.", 2)
        pass
