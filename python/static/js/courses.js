	...
	for (var i = 0; i < courses.length; i++)
	{
	    ...
	    else
	    {
	        ...
	        for (var ii=0;ii<grade_items.length; ii++)
	        {
	            ...
	            new_html = new_html + '<a class="grade-link" href="index.php?page=upload&course=' + course.id + '&grade_item=' + grade_item.id + '">' + grade_item.name + '</a>'
	        }
