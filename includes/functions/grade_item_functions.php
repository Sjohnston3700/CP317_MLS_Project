...
/**
 * @file
 * Collection of functions for performing functions for grade items
 */
 ...
 * @param  {Integer} max
 * @return {Array} If error, errors and error messages to be sent to frontend. 
 * @return {Array} If success, response from putting grade item
 */
