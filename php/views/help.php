<html>
    ...
    <body>
        ...
        <h2>Introduction</h2>
        <p>
         ezMarker is a web application that allows instructors at Wilfrid Laurier University to bulk 
            upload grades and feedback into MyLearningSpace, with the integration of the Brightspace API 
            supported by D2L. The goal of ezMarker is to solve the issues regarding inefficient manual 
            grade uploading through the current MyLearningSpace interface. On average, it can take 
            markers a few hours to manually upload grades for one class. Marking time is cut down to 
            minutes with the use of ezMarker's bulk file uploading.
		</p>
        ...
        <ul><li>
            Courses, username and logout button will be hidden</li></ul>
        <ul><li>
            The user will be given an option to select either Docs or Login</li>
        </ul>
        <img class="prototype-img"  src="<?=$PATH_TO_STATIC?>/img/homepage.png"border="1">
        <h3>Documents Page</h3>
        <p>
            If Docs is selected, the user will be sent to the documents page.</p>
        <p>
            Here they will have access to the following documents:</p>
        <ul><li>
            Software Planning</li></ul>
        <ul><li>
            ezMarker Requirements</li></ul>
        <ul><li>
            ezMarker Analysis</li></ul>
        <ul><li>
            ezMarker Design</li></ul>
        <ul><li>
            Wrapper Requirements</li></ul>
        <ul><li>
            Wrapper Analysis</li></ul>
        <ul><li>
            Wrapper Design</li></ul>
        <img class="prototype-img" src="<?=$PATH_TO_STATIC?>/img/docs_page.png"border="1">
        <h3>Login Page</h3>
        <p>
         ...
         <img class="prototype-img" src="<?=$PATH_TO_STATIC?>/img/brightspace_login.png"border="1">
        <p>
            If login is unsuccessful, the user is be shown an error message, and needs to retry.</p>
        <img class="prototype-img" src="<?=$PATH_TO_STATIC?>/img/login_failed.png"border="1">
        <h3>Accessing the Homepage</h3>
        <p>
            The user can always access the ezMarker homepage by clicking on the ezMarker logo on the 
            Navigation Bar.</p>
         <img class="prototype-img" src="<?=$PATH_TO_STATIC?>/img/homepage_access.png"border="1">
        ...
        <ul><li>
            ...
            how to navigate the ezMarker website.</li></ul>
        <img class="prototype-img" src="<?=$PATH_TO_STATIC?>/img/navbar_options.png"border="1">
        <p>
            The user will also be shown their name and the option to logout.</p>
        <img class="prototype-img" src="<?=$PATH_TO_STATIC?>/img/navbar_logout.png"border="1">
        ...
        <img class="prototype-img" src="<?=$PATH_TO_STATIC?>/img/course_listpage.png"border="1">
        <p>
            ...
            Grade Item page.</p>
        <img class="prototype-img" src="<?=$PATH_TO_STATIC?>/img/gradeitem_a1.png"border="1">
        ...
        <ul><li>
            Change Grade Maximum: Give user the ability to change the max grade limit</li></ul>
        <ul><li>
            Automated Upload: Give user the ability to upload an Autograder file</li></ul>
        <ul><li>
            Manual Grade Input: Give user the ability to update student grades manually</li></ul>
        <img class="prototype-img" src="<?=$PATH_TO_STATIC?>/img/gradeitems_page.png"border="1">
        ...
        <img class="prototype-img" src="<?=$PATH_TO_STATIC?>/img/update_grade_max.png"border="1">
        ...
        <img class="prototype-img" src="<?=$PATH_TO_STATIC?>/img/update_max_success.png"border="1">
        <h4>Invalid update </h4>
        <p>
            If an invalid grade maximum is given, an error message will appear and the user will have to check their input.</p>
        <img class="prototype-img" src="<?=$PATH_TO_STATIC?>/img/update_max_error.png"border="1">
        ...
        <img class="prototype-img" src="<?=$PATH_TO_STATIC?>/img/automated_upload.png"border="1">
        <h4>Upload successful</h4>
        <p>
            If the file is valid and grades are uploaded through the Brightspace API, the user is brought to the report page. 
        </p>
        <p>Note:</p>
        <ul><li>
            The comment for student feedback is not required.</li></ul>
        <img class="prototype-img" src="<?=$PATH_TO_STATIC?>/img/auto_reports_page.png"border="1">
        <h4>Upload error</h4>
        <p>
        ...
        <img class="prototype-img" src="<?=$PATH_TO_STATIC?>/img/automated_upload_error.png"border="1">
        
        <h3> Manual Grade Input</h3>
        <p>
            The user can also upload grades manually.</p>
        <img class="prototype-img" src="<?=$PATH_TO_STATIC?>/img/manual_grade_input.png"border="1">
        ...
        <img class="prototype-img" src="<?=$PATH_TO_STATIC?>/img/manual_input_name.png"border="1">
        <ul><li>
            Search for a student using their ID
            </li></ul>
        <img class="prototype-img" src="<?=$PATH_TO_STATIC?>/img/manual_input_id.png"border="1">
        <ul><li>
            Select all option will quickly add input boxes for all students
            </li></ul>
        <img class="prototype-img" src="<?=$PATH_TO_STATIC?>/img/manual_input_all.png"border="1">
        <h4>Removing students</h4>
        <p>
            Once a student is added, they can be removed by hitting the X- button beside their name. A 
            message in red will appear indicating which student was removed. </p>
        <img class="prototype-img" src="<?=$PATH_TO_STATIC?>/img/manual_grade_remove.png"border="1">
        ...
        <p>
            ...
            student grade, otherwise cancel their upload.</p>
        <p>
            If the grade item does not allow inputted grades to be greater than the maxamum grade value, 
            an error message will appear if the inputted grade exceed the max value. In this case, the 
            user is forced to input a grade less than or equal to the maximum grade value.
        </p>
        <img class="prototype-img" src="<?=$PATH_TO_STATIC?>/img/manual_upload_error.png"border="1">
        ...
        <img class="prototype-img" src="<?=$PATH_TO_STATIC?>/img/manual_upload_warning.png"border="1">
        ...
        <p>
            ...
            successfully set by the Brightspace API, any errors from the API, 
        ...
        <p>Note: </p>
        <ul><li>
            <strong>Logging out will not direct the user to ezMarker. Instead the user will be directed to the Brightspace instance.</strong></li>
        </ul>
        ...
        <p>- Added Homepage description.</p>
        <p>- Updated diagrams and pictures.</p>
        <p>- Added subheadings for better organization.</p>
